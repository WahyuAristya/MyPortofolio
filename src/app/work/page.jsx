...
const uiuxProjects = [
    {
        num: '01',
        category: 'UI/UX Design : KerjaYuk',
        title: 'Web Design',
        description: 'KerjaYuk is a platform that allows users to browse and apply for jobs. It provides a seamless and user-friendly experience for users to find and apply for jobs.',
        stack: [{name: 'Figma'}],
        image: '/assets/work/code2.jpg',
        live: 'https://finalproject-sanbercode-reactjs-batch-60.vercel.app/',
        figma: 'https://www.figma.com/design/h9dxzZZ4S0nczLlS4gAnES/Final-Project---Sanbercode-ReactJS-Batch-60?node-id=0-1&t=P1gQQdaW55jUqfJB-1',
    },
    {
        num: '02',
...
const graphicProjects = [
    ...
    },
    {
        ...
        stack: [{name: 'Adobe Illustrator'}],
        image: '/assets/work/graphic66.jpg',
...
const codeProjects = [
    ...
    {
        num: '02',
        category: 'Web Development : KerjaYuk',
        title: 'Web Development',
        description: 'Developed project for sanbercode batch 60 bootcamp ReactJS Final Project. This project is a web-based platform that allows users to browse and apply for jobs.',
